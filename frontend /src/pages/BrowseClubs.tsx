          ...
          <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
            ...
            <div className="relative flex-1 max-w-sm">
              ...
              <input
                ...
                value={search}
                onChange={(e) => setSearch(e.target.value)}
                className="w-full pl-9 pr-3 py-2 text-sm rounded-xl border border-white/20 bg-white/10 text-charcoal placeholder-charcoal focus:outline-none focus:ring-2 focus:ring-[#FBE118] transition-all"
              />
            </div>
            ...
            <div className="flex flex-wrap gap-2 items-center">
              <div className="flex items-center gap-2">
                <label className="text-xs text-charcoal font-medium whitespace-nowrap">
                  Status
                </label>
                <select
                  value={isActive}
                  ...
                  className="text-sm rounded-xl border border-white/20 bg-white/10 text-charcoal px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#FBE118] transition-all"
                >
                  <option value="all">All</option>
                  <option value="true">Active</option>
                  <option value="false">Inactive</option>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-white/10 bg-white/5">
                    ...
                    <th className="py-3 pr-4 text-xs font-semibold text-charcoal uppercase tracking-wide">
                      Name / SKU
                    </th>
                    <th className="py-3 pr-4 text-xs font-semibold text-charcoal uppercase tracking-wide hidden sm:table-cell">
                      Type
                    </th>
                    <th className="py-3 pr-4 text-xs font-semibold text-charcoal uppercase tracking-wide hidden md:table-cell">
                      Tracking
                    </th>
                    <th className="py-3 pr-4 text-xs font-semibold text-charcoal uppercase tracking-wide text-right hidden sm:table-cell">
                      Price
                    </th>
                    <th className="py-3 pr-4 text-xs font-semibold text-charcoal uppercase tracking-wide text-center hidden lg:table-cell">
                      Status
                    </th>
                    <th className="py-3 pr-4 text-xs font-semibold text-charcoal uppercase tracking-wide text-center hidden lg:table-cell">
                      Archived
