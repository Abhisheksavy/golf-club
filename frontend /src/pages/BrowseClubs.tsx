...
//                 value={search}
//                 onChange={(e) => setSearch(e.target.value)}
//                 className="w-full pl-9 pr-3 py-2 text-sm rounded-xl border border-white/20 bg-white/10 text-white placeholder-white focus:outline-none focus:ring-2 focus:ring-[#FBE118] transition-all"
//               />
//             </div>
...
//               <div className="flex items-center gap-2">
//                 <span className="text-xs text-white font-medium whitespace-nowrap">Status</span>
...
//               <div className="flex items-center gap-2">
//                 <span className="text-xs text-white font-medium whitespace-nowrap">Archived</span>
//                 <div className="relative">
//                   <button
//                     type="button"
