...
const ClubPreferenceChoice = () => {
  ...
  return (
    <div>
      ...
      <p className="text-golf-yellow mb-8">We can help narrow down the options based on your game.</p>
      ...
      <div className="grid gap-4">
        ...
        >
          ...
          <div>
            <p className="text-lg font-semibold text-golf-yellow">I'll choose my own clubs</p>
            <p className="text-sm text-[#EDD287] mt-1">Browse the full selection and pick what you like</p>
          </div>
        </button>
        ...
        >
          ...
          <div>
            <p className="text-lg font-semibold text-golf-yellow">Help me narrow it down</p>
            <p className="text-sm text-[#EDD287] mt-1">Answer a couple of questions and we'll suggest the right clubs</p>
          </div>
        </button>
      </div>
